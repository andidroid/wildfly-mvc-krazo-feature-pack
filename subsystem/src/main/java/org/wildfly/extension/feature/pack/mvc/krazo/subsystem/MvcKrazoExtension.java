 ...
 */
public class MvcKrazoExtension implements Extension
{
    ...
    static ResourceDescriptionResolver getResourceDescriptionResolver(final boolean useUnprefixedChildTypes, final String... keyPrefix)
    {
        ...
        return new StandardResourceDescriptionResolver(prefix.toString(), RESOURCE_NAME, MvcKrazoExtension.class.getClassLoader(), true, useUnprefixedChildTypes);
    }
    ...
    public void initialize(ExtensionContext extensionContext)
    {
        ...
        final ManagementResourceRegistration root = sr.registerSubsystemModel(new MvcKrazoSubsystemDefinition());
