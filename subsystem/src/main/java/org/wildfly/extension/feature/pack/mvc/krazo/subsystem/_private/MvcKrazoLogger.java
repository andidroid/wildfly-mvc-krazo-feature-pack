...
package org.wildfly.extension.feature.pack.mvc.krazo.subsystem._private;
...
@MessageLogger(projectCode = "WFLYMVC", length = 4)
public interface MvcKrazoLogger extends BasicLogger
{
    
    MvcKrazoLogger LOGGER = Logger.getMessageLogger(MvcKrazoLogger.class, "org.wildfly.extension.galleon.pack.mvc.krazo.subsystem");
    
    /**
     * Logs an informational message indicating the subsystem is being activated.
     */
    @LogMessage(level = INFO)
    @Message(id = 1, value = "Activating MVC Krazo Subsystem")
