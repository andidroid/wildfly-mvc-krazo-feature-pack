...
public class SubsystemParser_1_0 extends PersistentResourceXMLParser
{
    ...
    public static final String NAMESPACE = "urn:wildfly:mvc-krazo:1.0";
    
    private static final PersistentResourceXMLDescription xmlDescription = builder(MvcKrazoExtension.SUBSYSTEM_PATH, NAMESPACE).build();
